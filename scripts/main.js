function extractImportantInfo(list) {
...
function compareLists() {
  ...
  const cleanFollowers = extractImportantInfo(followers);
  const cleanFollowing = extractImportantInfo(following);
  ...
  function showOutput() {
    ...
    outputElement1.scrollIntoView({behavior: "smooth", block: "start"});
